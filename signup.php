					...
					<div class="row mx-sm-0 mx-2">
						...
						<div class="col-lg-6 main_grid_contact" style="width: 200px; margin: auto;">
							<div class="form-w3ls p-md-5 p-4">
								...
								<form action="xuly/dosignup.php" method="post" id="formreg">
									<div class="row">
									...
									<div class="form-group">
										<input class="form-control" type="password" id="txtpass" name="pass" placeholder="Password"
										required="">
									</div>
									<div class="form-group">
										<input class="form-control" type="password" name="pass" id="txtpass2" placeholder="Password confirm.."
										required="">
									</div>
									<div class="form-group">
