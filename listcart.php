...
<body>
	<div class="header">
		...
		<div class="main-cart container">
			<h3 style="font-size: 35px;" class="title-w3ls text-center text-bl mb-5" > Your Cart
			</h3>
				...
				<div class="table cart_info" >
					<table class="table table-condensed">
							...
							if (isset($_SESSION['cart'])) {
								...
								foreach ($_SESSION['cart'] as $key){
									...
									<tr>
										...
										<input type="hidden" name="name" value="<?php echo $key["name"] ?>">	<p><b><?php echo $key["name"] ?> </b></p>
										...
										<td class="cart_total" style="width: 50px;">
											<input type="hidden" name="price" value="<?php 
												echo number_format($key["qty"] * $key["price"]); ?>">
									...
									<tr>
										...
										<td colspan="2">
											...
											<td class="cart_total">
												<input type="hidden" name="totalprice" value="<?php echo number_format($total,1); ?>">
						...
						<div  class="submit" style="float:right"> 
								 <a href="login.php"><input type="submit" class="btn btn-default check_out" name="submit" value="Check Out"></a>	 
						 </div> 	
						 
						<a  class="btn btn-default check_out" href="product.php">Continue Shopping</a>
